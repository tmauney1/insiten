...
var DeleteContactWarningDialogData = /** @class */ (function () {
    function DeleteContactWarningDialogData() {
    }
    return DeleteContactWarningDialogData;
}());

var DeleteContactWarningDialogComponent = /** @class */ (function () {
    function DeleteContactWarningDialogComponent(dialogRef, data, targetService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.targetService = targetService;
    }
    DeleteContactWarningDialogComponent.prototype.delete = function (target) {
        console.log(this.data.targets);
        this.data.targets = this.data.targets.filter(function (h) { return h !== target; });
        console.log(this.data.targets);
        this.targetService.deleteTarget(target).subscribe();
    };
    DeleteContactWarningDialogComponent.prototype.removeContact = function (contact) {
        //console.log (this.target.keyContacts);
        this.data.target.keyContacts = this.data.target.keyContacts.filter(function (i) { return i !== contact; });
        //console.log (this.target.keyContacts);
    };
    ...
    return DeleteContactWarningDialogComponent;
}());
...
var DeleteWarningDialogData = /** @class */ (function () {
    function DeleteWarningDialogData() {
    }
    return DeleteWarningDialogData;
}());

var DeleteWarningDialogComponent = /** @class */ (function () {
    function DeleteWarningDialogComponent(dialogRef, data, targetService) {
        this.dialogRef = dialogRef;
        this.data = data;
        this.targetService = targetService;
    }
    DeleteWarningDialogComponent.prototype.delete = function (target) {
        console.log(this.data.targets);
        this.data.targets = this.data.targets.filter(function (h) { return h !== target; });
        console.log(this.data.targets);
        this.targetService.deleteTarget(target).subscribe();
...
var InMemoryDataService = /** @class */ (function () {
    ...
    InMemoryDataService.prototype.genId = function (targets) {
        return targets.length > 0 ? Math.max.apply(Math, targets.map(function (target) { return target.id; })) + 1 : 11;
    };
...
var FinancialIdicators = /** @class */ (function () {
    function FinancialIdicators() {
    }
    return FinancialIdicators;
}());
...
var SuccessDialogData = /** @class */ (function () {
    function SuccessDialogData() {
    }
    return SuccessDialogData;
}());
...
var TargetDetailComponent = /** @class */ (function () {
    function TargetDetailComponent(route, targetService, location, dialog) {
        this.route = route;
        this.targetService = targetService;
    ...
    TargetDetailComponent.prototype.onSaveChanges = function () {
        this.target.dateLastUpdated = new Date;
        this.targetService.updateTarget(this.target).subscribe();
    };
    TargetDetailComponent.prototype.trackByFn = function (index, item) {
        return index;
    };
    TargetDetailComponent.prototype.addContact = function (addContactName, addContactPhoneNumber) {
        var obj;
    ...
    TargetDetailComponent.prototype.onSelect = function (contact) {
        this.selectedContact = contact;
    };
    TargetDetailComponent.prototype.openDeleteContactWarningDialog = function () {
        ...
        var dialogData = new _delete_contact_warning_dialog_delete_contact_warning_dialog_component__WEBPACK_IMPORTED_MODULE_8__["DeleteContactWarningDialogData"]();
        ...
        // Open the dialog.
        var dialogRef = this.dialog.open(_delete_contact_warning_dialog_delete_contact_warning_dialog_component__WEBPACK_IMPORTED_MODULE_8__["DeleteContactWarningDialogComponent"], dialogConfig);
...
var TargetService = /** @class */ (function () {
    function TargetService(http, messageService, dialog) {
        this.http = http;
    ...
    TargetService.prototype.getTargets = function () {
        var _this = this;
        return this.http.get(this.targetsUrl).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log('fetched targets'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getTargets', [])));
    };
    TargetService.prototype.getTarget = function (id) {
        var _this = this;
        var url = this.targetsUrl + "/" + id;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("fetched target id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getTarget id=" + id)));
    };
    TargetService.prototype.updateTarget = function (target) {
        var _this = this;
        return this.http.put(this.targetsUrl, target, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("updated target id=" + target.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('updateTarget')));
    };
    TargetService.prototype.addTarget = function (target) {
        var _this = this;
        return this.http.post(this.targetsUrl, target, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (newTarget) { return _this.log("added target w/ id=" + newTarget.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('addtarget')));
    };
    TargetService.prototype.deleteTarget = function (target) {
        var _this = this;
        var id = typeof target === 'number' ? target : target.id;
        var url = this.targetsUrl + "/" + id;
        return this.http.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.log("deleted target id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteTarget')));
    };
    /**
   ...
   */
    ...
    TargetService.prototype.openSubmitSuccessDialog = function () {
        // Create a dialog configuration so we can customize the dialog. 
        ...
        // Add the data that we're going to pass to the dialog to the config.
        var dialogData = new _success_dialog_success_dialog_component__WEBPACK_IMPORTED_MODULE_7__["SuccessDialogData"]();
...
var TargetsComponent = /** @class */ (function () {
    function TargetsComponent(targetService, dialog) {
        this.targetService = targetService;
        this.dialog = dialog;
    ...
    TargetsComponent.prototype.onSelect = function (target) {
        this.selectedTarget = target;
    };
    //Add new account target
    TargetsComponent.prototype.add = function (targetName, targetStatus, targetCompanyStreet, targetCompanyCity, targetCompanyState, targetCompanyZip, targetCompanyInfo, targetKeyContactName, targetKeyContactPhoneNumber, targetRevenue, targetExpenses) {
        var _this = this;
        var obj = {
            name: targetName,
            status: targetStatus,
    ...
    TargetsComponent.prototype.openDeleteWarningDialog = function () {
        var _this = this;
        // Create a dialog configuration so we can customize the dialog. 
        ...
        dialogConfig.panelClass = "warning-dialog";
        // Add the data that we're going to pass to the dialog to the config.
        var dialogData = new _delete_warning_dialog_delete_warning_dialog_component__WEBPACK_IMPORTED_MODULE_8__["DeleteWarningDialogData"]();
        dialogData.title = 'Warning';
        ...
        dialogConfig.data = dialogData;
        // Open the dialog.
        var dialogRef = this.dialog.open(_delete_warning_dialog_delete_warning_dialog_component__WEBPACK_IMPORTED_MODULE_8__["DeleteWarningDialogComponent"], dialogConfig);
        dialogRef.afterClosed().subscribe(function () {
            _this.getTargets();
        });
    };
